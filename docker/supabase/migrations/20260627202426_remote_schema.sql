...
CREATE OR REPLACE FUNCTION "public"."register_embedded"("mac_address_" "text") RETURNS TABLE("id" "uuid", "subdomain" bigint, "passkey" "text", "status" "public"."embedded_status")
    LANGUAGE "plpgsql"
    AS $$
  BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."register_embedded"("mac_address_" "text") OWNER TO "supabase_admin";
...
CREATE POLICY "select_policy" ON "public"."metrics" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."embedded" "e"
...
GRANT ALL ON FUNCTION "public"."register_embedded"("mac_address_" "text") TO "postgres";
GRANT ALL ON FUNCTION "public"."register_embedded"("mac_address_" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."register_embedded"("mac_address_" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."register_embedded"("mac_address_" "text") TO "service_role";
