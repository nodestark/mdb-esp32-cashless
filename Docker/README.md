...
4. Change the following Parameters to your desire:
    ...
    ---
    **Note for Dev System testing**

    For `SUPABASE_PUBLIC_URL` and `API_EXTERNAL_URL` you can set your local IP address with port 8000 like e.g. `API_EXTERNAL_URL=http://10.0.1.181:8000`
    
    Also the `MQTT_HOST` should then be your local IP Address (without Port)
